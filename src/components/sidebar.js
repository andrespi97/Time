        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li>
              ...
              >
                <span className="pi pi-list-check"></span>
                {/* listas */}
                <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800  rounded-full  dark:text-gray-300">
            ...
            <li>
              <a
                ...
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="pi pi-folder-plus"></span>
            ...
            <li>
              <a
                ...
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <span className="pi pi-file-plus"></span>
                <span class="flex-1 ms-3 whitespace-nowrap">
                  <AddTask
                    auth={auth}
                    calendars={calendars}
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">example</span>
              </a>
            </li>
            <li>
              <a
